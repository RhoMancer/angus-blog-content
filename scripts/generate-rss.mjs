...
.alert-error {
  ...
  border-left: .4rem solid var(--error); padding: .75rem 1rem; border-radius: .5rem;
    ...
    p{font-family:'Merriweather', serif;font-size:1.05em;}
    main{max-width:720px;margin:0 auto;padding:16px}
    li{margin:8px 0}
    li a{font-family:'Merriweather', serif;font-size:1.1em;}
